...
import memeStakeLogo from "@assets/photo_6165874261982561339_y_1756486927703.jpg";
...
export default function Home() {
  ...
  return (
    <div className="bg-background text-foreground">
      ...
      {/* Hero Section */}
      <section className="section-padding text-center relative" data-testid="section-hero">
      ...
      {/* Countdown Section */}
      <section className="py-16 relative" data-testid="section-countdown">
        <div className="container">
          <div className="text-center">
            <Card className="p-8 max-w-4xl mx-auto relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                {/* Countdown Timer */}
                <div className="glass-card p-8 rounded-2xl border-2 relative" 
                     style={{
                ...
                <div className="mt-8">
                  <Button 
                    onClick={() => setWalletModalOpen(true)}
                    className="text-xl px-10 py-6 rounded-xl font-bold transition-all duration-300 hover:scale-105"
                    style={{
                      background: '#ffd700',
                      color: '#0a0e1a',
                      fontWeight: '700',
                    ...
                    data-testid="button-join-airdrop"
                  >
                    🎁 Join Airdrop
                  </Button>
                </div>
                ...
                <div className="mt-6 flex justify-center">
                  <div className="flex items-center bg-gradient-to-r from-green-500/20 to-cyan-500/20 px-4 py-2 rounded-full border border-green-500/30">
      ...
      <section className="section-padding crypto-bg relative" data-testid="section-dashboard">
        <div className="container">
          ...
          <div className="max-w-6xl mx-auto">
            <iframe 
              src="https://mems-ui-server-dashbaord.replit.app/" 
              className="w-full h-[800px] rounded-lg border border-border"
              style={{
                background: 'linear-gradient(135deg, rgba(15, 20, 35, 0.8) 0%, rgba(30, 15, 60, 0.8) 100%)',
        ...
        <div className="container">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center p-6 rounded-lg" style={{background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 215, 0, 0.2)'}}>
              ...
              <div className="text-center p-6 rounded-lg" style={{background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(0, 191, 255, 0.2)'}}>
                <div className="text-2xl mb-2">💎</div>
              ...
              <div className="text-center p-6 rounded-lg" style={{background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.2)'}}>
                <div className="text-2xl mb-2">👥</div>
      ...
      {/* FAQ Section */}
      <section id="faq" className="section-padding" data-testid="section-faq">
        <div className="container">
          <div className="text-center mb-16">
          ...
          <div className="cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <div className="space-y-4">
              {faqItems.map((item, index) => (
                <details key={index} className="group p-4 rounded-lg border border-border hover:border-primary/20 transition-all cursor-pointer" data-testid={`faq-item-${index}`}>
              ...
              {/* Help Card */}
              <Card className="p-6 mt-8" data-testid="card-help">
                <div className="text-center">
                  ...
                  <Button asChild variant="outline" data-testid="button-join-telegram">
                    <a href="https://t.me/memestake_official">Join our Telegram</a>
                  </Button>
                </div>
              </Card>

              {/* Additional FAQ Items */}
              <details className="group p-4 rounded-lg border border-border hover:border-primary/20 transition-all cursor-pointer" data-testid="faq-tokenomics">
                <summary className="flex items-center justify-between font-medium text-foreground list-none">
                  <span>Where can I find tokenomics details?</span>
                  <span className="text-primary text-xl">+</span>
                </summary>
                <p className="text-sm text-muted-foreground mt-3">
              ...
              <details className="group p-4 rounded-lg border border-border hover:border-primary/20 transition-all cursor-pointer" data-testid="faq-vesting">
                <summary className="flex items-center justify-between font-medium text-foreground list-none">
                  <span>Are there any token locks or vesting?</span>
                  <span className="text-primary text-xl">+</span>
                </summary>
                <p className="text-sm text-muted-foreground mt-3">
              ...
              <details className="group p-4 rounded-lg border border-border hover:border-primary/20 transition-all cursor-pointer" data-testid="faq-wallets">
                <summary className="flex items-center justify-between font-medium text-foreground list-none">
      ...
      {/* About Section */}
      <section id="about" className="section-padding" data-testid="section-about">
        <div className="container">
          <div className="cols-2 items-center gap-12">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6">
                ...
                Our team of experienced developers and crypto enthusiasts is creating a platform where meme lovers can earn real rewards.
              </p>
              <p className="text-muted-foreground mb-8">
                Founded by experienced DeFi developers and meme enthusiasts, MemeStake represents a new generation 
                of cryptocurrency projects that combine entertainment with real financial utility. Our audited smart contracts 
                ensure your funds are always secure while you earn passive income from your favorite meme tokens.
              </p>
            </div>
            
            {/* Smart Contract Code Preview */}
            <Card className="p-6 relative overflow-hidden" style={{background: 'linear-gradient(135deg, rgba(255, 215, 0, 0.05) 0%, rgba(0, 191, 255, 0.05) 100%)'}}>
