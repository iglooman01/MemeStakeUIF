...
export const CONTRACTS = {
  ...
  // Staking Contract
  MEMES_STAKE: {
    address: "0x75c56caFa05D62eC739E15cF5F692DF946a6EaD6",
    abi: [
      {
        inputs: [],
      ...
      {
        inputs: [],
        name: "MAX_REWARD_PERCENTAGE_BPS",
        outputs: [
          {
            internalType: "uint256",
            name: "",
      ...
      },
      {
        ...
        name: "totalClaimedRewardsByReferralLevel",
        outputs: [
          {
            internalType: "uint256",
            name: "",
  ...
  MEMES_AIRDROP: {
    address: "0x55f9E46e491c1fEAa79B20093C33E873622CF976",
    abi: [
      {
        "inputs": [
          {
  ...
  // Presale Contract
  MEMES_PRESALE: {
    address: "0x75CC56E161E388EdDFF340762173CD76e5A199ca",
    abi: [
      {
        inputs: [],
        name: "acceptOwnership",
