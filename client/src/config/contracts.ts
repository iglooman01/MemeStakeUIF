...
export const CONTRACTS = {
  ...
  // Staking Contract
  MEMES_STAKE: {
    address: "0x0652Cbe4ec9203E27947082Bf96fA02fc2841fe7",
    abi: [
      {
        inputs: [],
        ...
        outputs: [
          {
            components: [
              { internalType: "uint256", name: "stakeId", type: "uint256" },
              {
                ...
                internalType: "struct MemestakeStaking.Stake",
                name: "details",
                type: "tuple",
              },
            ],
            internalType: "struct MemestakeStaking.StakeWithId[]",
            name: "activeStakes",
            type: "tuple[]",
          },
        ],
      ...
      },
      {
        ...
        outputs: [
          ...
          { internalType: "uint256", name: "level1Total", type: "uint256" },
          { internalType: "uint256", name: "level2Total", type: "uint256" },
          { internalType: "uint256", name: "level3Total", type: "uint256" },
        ],
        stateMutability: "view",
        type: "function",
      },
      {
        inputs: [{ internalType: "address", name: "_user", type: "address" }],
        name: "getTotalStakedByReferralLevel",
        outputs: [
          { internalType: "uint256", name: "level1Total", type: "uint256" },
          { internalType: "uint256", name: "level2Total", type: "uint256" },
          { internalType: "uint256", name: "level3Total", type: "uint256" },
      ...
      },
      {
        ...
        name: "totalRewardsByReferralLevel",
        outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
        stateMutability: "view",
        type: "function",
      },
      ...
      },
      {
        ...
        name: "totalStakedByReferralLevel",
        outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
        stateMutability: "view",
        type: "function",
      },
  ...
  MEMES_PRESALE: {
    ...
    abi: [
      ...
      {
        inputs: [
          { internalType: "address", name: "_memesToken", type: "address" },
          {
            internalType: "address[]",
            name: "acceptedTokens",
            type: "address[]",
          ...
          { internalType: "bool[]", name: "isOldToken", type: "bool[]" },
          {
            internalType: "address",
