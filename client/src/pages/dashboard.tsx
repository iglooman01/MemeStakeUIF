  ...
  return (
    <div className="min-h-screen text-foreground" style={{background: 'linear-gradient(135deg, #0a0e1a 0%, #1a1f2e 50%, #0f1421 100%)'}} data-testid="dashboard-page">
      ...
      <div className="max-w-6xl mx-auto px-6 py-8 space-y-6">
        ...
        {/* Claim Your MEMES Airdrop Section */}
        <Card className="p-8 glass-card" style={{background: 'linear-gradient(135deg, rgba(15, 10, 35, 0.95), rgba(30, 15, 60, 0.95))', border: '2px solid rgba(255, 215, 0, 0.3)'}}>
          <h2 className="text-3xl font-bold mb-3 text-center" style={{color: '#ffd700'}}>
            Claim Your MEMES Airdrop
          </h2>
          <p className="text-center text-gray-400 mb-8">
            Complete the verification steps below to claim your exclusive MEMES tokens from our decentralized airdrop <span style={{color: '#ffd700'}}>direct in your wallet</span> and join our growing community.
          </p>

          {/* 1. Email Verification */}
          <div className="mb-8">
            <h3 className="text-xl font-semibold mb-4" style={{color: '#00bfff'}}>1. Email Verification</h3>
            ...
            {!emailVerified ? (
              <div className="flex gap-3">
                ...
                <Button
                  ...
                  data-testid="button-send-otp-verification"
                >
                  📧 Send OTP
                </Button>
                <Button
          ...
          <div className="mb-8">
            <h3 className="text-xl font-semibold mb-4" style={{color: '#00bfff'}}>2. Social Media Tasks</h3>
            
            {!emailVerified ? (
              <div className="p-6 rounded-lg text-center" style={{background: 'rgba(0, 0, 0, 0.3)', border: '1px solid rgba(255, 215, 0, 0.3)'}}>
                <div className="text-gray-400 mb-2">🔒 Verify your email first to unlock tasks</div>
              </div>
            ) : (
              <div className="space-y-3">
                <div className="p-4 rounded-lg flex items-center justify-between" style={{background: 'rgba(0, 191, 255, 0.1)', border: '1px solid rgba(0, 191, 255, 0.3)'}}>
                  <div className="flex items-center gap-3">
                    <SiTelegram className="w-6 h-6" style={{color: '#00bfff'}} />
                    <span className="text-white">Join Telegram Group</span>
                  </div>
                  <Button variant="outline" size="sm" style={{borderColor: '#00bfff', color: '#00bfff'}} data-testid="button-task-telegram-group">
                    {tasksCompleted.telegram_group ? '✓ Done' : 'Complete'}
                  </Button>
                </div>
                ...
                <div className="p-4 rounded-lg flex items-center justify-between" style={{background: 'rgba(0, 191, 255, 0.1)', border: '1px solid rgba(0, 191, 255, 0.3)'}}>
                  <div className="flex items-center gap-3">
                    <SiTelegram className="w-6 h-6" style={{color: '#00bfff'}} />
                    <span className="text-white">Join Telegram Channel</span>
                  </div>
                  <Button variant="outline" size="sm" style={{borderColor: '#00bfff', color: '#00bfff'}} data-testid="button-task-telegram-channel">
                    {tasksCompleted.telegram_channel ? '✓ Done' : 'Complete'}
                  </Button>
                </div>

                <div className="p-4 rounded-lg flex items-center justify-between" style={{background: 'rgba(0, 191, 255, 0.1)', border: '1px solid rgba(0, 191, 255, 0.3)'}}>
                  <div className="flex items-center gap-3">
                    <SiX className="w-6 h-6" style={{color: '#00bfff'}} />
                    <span className="text-white">Follow on Twitter/X</span>
                  </div>
                  <Button variant="outline" size="sm" style={{borderColor: '#00bfff', color: '#00bfff'}} data-testid="button-task-twitter">
                    {tasksCompleted.twitter ? '✓ Done' : 'Complete'}
                  </Button>
                </div>
                ...
                <div className="p-4 rounded-lg flex items-center justify-between" style={{background: 'rgba(0, 191, 255, 0.1)', border: '1px solid rgba(0, 191, 255, 0.3)'}}>
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-white">Subscribe YouTube</span>
                  </div>
                  <Button variant="outline" size="sm" style={{borderColor: '#00bfff', color: '#00bfff'}} data-testid="button-task-youtube">
                    {tasksCompleted.youtube ? '✓ Done' : 'Complete'}
                  </Button>
                </div>

                <div className="mt-4 p-3 rounded-lg" style={{background: 'rgba(255, 215, 0, 0.1)', border: '1px solid rgba(255, 215, 0, 0.3)'}}>
                  <div className="flex items-center justify-between">
                    <span className="text-white">Progress:</span>
                    <span className="font-bold" style={{color: '#ffd700'}}>{Object.values(tasksCompleted).filter(Boolean).length}/4 Tasks</span>
                  </div>
                </div>
              </div>
            )}
          ...
          {/* 3. Your Airdrop Status */}
          <div className="mb-8">
            <h3 className="text-xl font-semibold mb-4" style={{color: '#00bfff'}}>3. Your Airdrop Status</h3>
            <div className="p-6 rounded-lg" style={{background: 'rgba(0, 255, 136, 0.1)', border: '1px solid rgba(0, 255, 136, 0.3)'}}>
              ...
              <div className="flex items-center gap-2 text-sm" style={{color: '#00ff88'}}>
                ...
                <span>🔗 Wallet connection required for token distribution</span>
              </div>
            </div>
          </div>
          ...
          <div>
            <h3 className="text-xl font-semibold mb-4" style={{color: '#00bfff'}}>4. Token & Referral Details</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
              <div className="p-4 rounded-lg text-center" style={{background: 'rgba(255, 215, 0, 0.1)', border: '1px solid rgba(255, 215, 0, 0.3)'}}>
                <div className="text-sm text-gray-400 mb-1">Your Referrals:</div>
                <div className="text-2xl font-bold" style={{color: '#ffd700'}}>1</div>
              </div>
              <div className="p-4 rounded-lg text-center" style={{background: 'rgba(0, 191, 255, 0.1)', border: '1px solid rgba(0, 191, 255, 0.3)'}}>
                <div className="text-sm text-gray-400 mb-1">Your Referral Tokens:</div>
                <div className="text-2xl font-bold" style={{color: '#00bfff'}}>0</div>
              </div>
              <div className="p-4 rounded-lg text-center" style={{background: 'rgba(0, 255, 136, 0.1)', border: '1px solid rgba(0, 255, 136, 0.3)'}}>
                <div className="text-sm text-gray-400 mb-1">Airdrop Tokens:</div>
                <div className="text-2xl font-bold" style={{color: '#00ff88'}}>0</div>
              </div>
            </div>
            <div className="p-3 rounded-lg text-center text-sm text-gray-400" style={{background: 'rgba(0, 0, 0, 0.3)', border: '1px solid rgba(255, 215, 0, 0.3)'}}>
              Referral tokens will be claimed slot by slot after tokens launching
            </div>
            <div className="mt-4 p-4 rounded-lg" style={{background: 'rgba(0, 191, 255, 0.1)', border: '1px solid rgba(0, 191, 255, 0.3)'}}>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  style={{background: 'rgba(0, 0, 0, 0.3)', border: '1px solid rgba(0, 191, 255, 0.3)'}}
                  data-testid="input-referral-link"
                />
                <Button size="sm" style={{background: '#00bfff', color: '#000'}} data-testid="button-copy-referral">
                  Copy
                </Button>
              </div>
            </div>
